/* Amplify Params - DO NOT EDIT
	API_INSPORATIONALQUOTE_GRAPHQLAPIIDOUTPUT
	API_INSPORATIONALQUOTE_QUOTEAPPDATATABLE_ARN
	API_INSPORATIONALQUOTE_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
async function updateQuoteDDBObject() {
	const quoteTableName =
		process.env.API_INSPORATIONALQUOTE_QUOTEAPPDATATABLE_NAME;
...
exports.handler = async (event) => {
	...
	async function getRandomQuote(apiURLInput) {
        ...
        <svg width="${width}" height="${height}">
          ...
          <circle cx='382' cy='76' r='44' fill='rgb(255, 255, 255, 0.155)' />
          ...
          <text x="${width / 2}" y="${
			height - 10
		}" class="footerStyles">Developed by Daniel Broe | Quotes from ZenQuotes.io</text>
          </svg>
        `;
